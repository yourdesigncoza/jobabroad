---
faqs:
  - q: Can a South African CA(SA) work in the UK without writing more exams?
    a: >-
      Yes. SAICA has a Reciprocal Membership Agreement with both ICAEW and ICAS,
      so a CA(SA) in good standing can obtain ACA (ICAEW) or CA (ICAS)
      membership without sitting additional exams. This covers all non-audit
      finance roles such as financial controller, FP&A, and CFO. Signing UK
      statutory audits is the one exception: it requires a separate ICAEW Audit
      Qualification, which the SAICA agreement does not grant.
  - q: Which countries can a CA(SA) move to without re-sitting accounting exams?
    a: >-
      If you hold a CA(SA) earned through the standard SAICA Professional
      Pathway Program, you can obtain professional membership in the UK,
      Australia, New Zealand, Canada, and Ireland without sitting further exams,
      thanks to SAICA's Mutual and Reciprocal Recognition Agreements. The MRAs
      cover professional membership only; public practice certificates, audit
      signing rights, and tax agent registration are separate requirements in
      each country. Canada also requires completing the CPARPD course and
      registering with a provincial CPA body.
  - q: >-
      What documents do I need to apply to work abroad as a South African
      accountant?
    a: >-
      Three SA-side foundation documents underpin every application: a SAICA
      Letter of Good Standing (free, 2 to 5 business days, valid 3 months), a
      SAPS Police Clearance Certificate (R190, valid 6 months from issue), and a
      DIRCO Apostille on that PCC (free). You run two separate streams in
      parallel: the designation stream that converts your CA(SA) via the MRA,
      and the immigration stream for the visa. Start your SA-side preparation at
      least 3 to 4 months before submitting any visa application, as the
      bottlenecks are all on the SA side.
  - q: How much does it cost a South African accountant to move to the UK?
    a: >-
      The biggest UK cost driver is the Immigration Health Surcharge at £1,035
      per year per person, which is £3,105 for a single applicant on a 3-year
      visa, with no waiver for accountants. On top of that are the ICAEW
      membership application of about £483, the UK Skilled Worker Visa (£819 for
      up to 3 years), and a UK TB test of around R3,000. Total out-of-pocket for
      a single applicant ranges from about R95,000 (low scenario, outside
      London) to around R230,000 (high scenario, London with family).
  - q: >-
      How do I avoid scams when applying for international accounting
      recognition?
    a: >-
      The one rule that covers everything: no legitimate party in the ICAEW, CA
      ANZ, CPA Canada, or CPA Ireland recognition process charges fees via a
      third party. Every application fee, membership fee, and Letter of Good
      Standing is paid directly to the named official body, so anyone asking you
      to pay these fees through them is committing fraud. Be wary of agencies
      offering to fast-track your SAICA MRA application, recruiters claiming
      your CA(SA) plus ICAEW membership gives full UK audit signing rights, and
      any CPA Canada service that won't name the specific provincial body. Every
      check is free and takes under five minutes by going directly to the
      official body's website.
---
