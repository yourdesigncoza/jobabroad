...
// Per-guide share card: brand wordmark + guide title + kicker.
export const alt = 'Jobabroad — work-abroad guide share card';
...
export default async function GuideOgImage({
  ...
  const kicker = page?.frontmatter.kicker ?? 'Work Abroad Guide';
