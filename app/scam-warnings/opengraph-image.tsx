...
export const alt = 'Jobabroad — Scam Warnings';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

export default function ScamWarningsOgImage() {
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          >
            How to spot work-abroad scams targeting South Africans
          </div>
          <div style={{ fontSize: '28px', color: 'rgba(248,245,240,0.78)', maxWidth: '1000px', lineHeight: 1.4 }}>
            Common patterns, how they reach you, where to report them.
          </div>
        </div>

        <div style={{ fontSize: '30px', color: '#C9A84C', fontWeight: 700 }}>
          jobabroad.co.za/scam-warnings
        </div>
      </div>
    ),
    { ...size },
