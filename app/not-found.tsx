...
const QUICK_LINKS = [
  { href: '/', label: 'Home' },
  { href: '/pathways/healthcare', label: 'Healthcare' },
  { href: '/pathways/teaching', label: 'Teaching' },
  { href: '/pathways/it-tech', label: 'IT / Tech' },
  { href: '/pathways/engineering', label: 'Engineering' },
  { href: '/pathways/trades', label: 'Trades' },
  { href: '/pathways/farming', label: 'Farming' },
  { href: '/pathways/hospitality', label: 'Hospitality' },
  { href: '/pathways/seasonal', label: 'Carnival / Seasonal' },
  { href: '/pathways/tefl', label: 'TEFL' },
  { href: '/pathways/au-pair', label: 'Au Pair' },
